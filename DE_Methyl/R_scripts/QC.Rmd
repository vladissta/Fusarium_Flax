...
clusterSamples(meth_3l, dist="euclidean", method="centroid", plot=TRUE)
```

#### _For uniting 2 replicates - same_
```{r, echo=FALSE, eval=FALSE}
clusterSamples(meth_2l, dist="euclidean", method="centroid", plot=TRUE)
```

#### _For uniting 1 replicates -same_
```{r, echo=FALSE, eval=FALSE}
clusterSamples(meth_1l, dist="euclidean", method="centroid", plot=TRUE)
```
