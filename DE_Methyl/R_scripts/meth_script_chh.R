...
load('./meth_kit_atf_vs_lmf_chh.RData')
...
#                                                     "LMF3-1", 'LMF3-2', 'LMF3-3'), read.context = 'CHH',
...
#save.image('../meth_kit_atf_vs_lmf_chh.RData')
...
write.csv(de_meth_1l, '../table_atf_vs_lmf_3_chh_1l_1000_step_500.csv')
write.csv(de_meth_2l, '../table_atf_vs_lmf_3_chh_2l_1000_step_500.csv')
write.csv(de_meth_3l, '../table_atf_vs_lmf_3_chh_3l_1000_step_500.csv')
save.image('../meth_kit_atf_vs_lmf_chh.RData')
