...
myobj <- processBismarkAln(ls_files, sample.id = list("AtF3-1","AtF3-2","AtF3-3",
                                                      "LMF-1", 'LMF-2', 'LMF-4'), read.context = 'CHH',
...
write.csv(de_meth_2l, 'table_atf3_vs_lmf3_chh_2l_1000_step_500.csv')
write.csv(de_meth_3l, 'table_atf3_vs_lmf3_chh_3l_1000_step_500.csv')
save(meth_2l, meth_3l, myobj.norm, file= 'meth_kit_atf3_vs_lmf3_chh.RData')